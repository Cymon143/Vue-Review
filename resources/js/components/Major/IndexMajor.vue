<template>
                        ...
                        <div class="card-header p-3">
                            ...
                            <div class="card-tools float-left">
                                <div class="input-group input-group-sm" >
                                    ...
                                    <button class="btn btn-success btn-sm ml-auto" @click="openAddModal" v-if="can('create major')"><i class="fas fa-plus"></i> Add</button>
                                </div>
                            </div>
                            ...
                            <table class="table table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    <tr v-for="(data, index) in option_users.data" :key="index">
                                        ...
                                        <td class="text-right">
                                            <button type="button" class="btn btn-primary btn-sm" @click="openEditModal(data)" v-if="can('edit major')"><i class="fas fa-edit"></i> Edit</button>
                                            <button type="button" class="btn btn-danger btn-sm" @click="remove(data.id)" v-if="can('delete major')"><i class="fas fa-trash-alt"></i> Remove</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <script>
    import addModal from "./AddMajor.vue";
    import EditModal from "./EditMajor.vue";
    export default {
        components: {
            addModal,
            EditModal,
            ...
            remove(id){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.delete('/api/major/delete/'+id)
                        .then(response => {
                            Swal.fire(
                                'Deleted!',
