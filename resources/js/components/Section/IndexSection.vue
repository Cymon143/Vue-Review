<template>
                            ...
                            <table class="table table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    <tr v-for="(data, index) in option_users.data" :key="index">
                                        ...
                                        <!-- <td>{{data.hour}}</td> -->
                                        <td>{{data.level}}</td>
                                        <td>{{data.adviser.name}} <strong>[{{data.adviser.major.name}}]</strong></td>
    ...
    <script>
    import addModal from "./AddSection.vue";
    import EditModal from "./EditSection.vue";
    export default {
        components: {
            addModal,
            EditModal,
