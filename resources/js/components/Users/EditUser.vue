            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <label>Department</label>
                            <multiselect v-model="form.major" :options="option_majors" :multiple="false" :close-on-select="true" :clear-on-select="false" :preserve-search="true" placeholder="Pick some" label="name" track-by="id" :preselect-first="true">
                        </multiselect>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <select v-model="form.status_substitute" class="form-control">
